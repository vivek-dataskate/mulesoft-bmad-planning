...
DataSkate maintains a template system that generates all client-facing and internal HTML documents. All templates live in `commons/templates/`. Content is always sourced from JSON or Markdown — never hardcoded into HTML.
...
| Document | Who uses it | Generated by | Template |
|---|---|---|---|
| Intake Questionnaire | Client fills it in | Scout | `commons/templates/intake-template.html` |
| Proposal | Client reads + agrees | Scout | `commons/templates/proposal-template.html` |
| Integration Deck | Client — deep-research pitch deck | Scout (research session) | `commons/templates/integration-deck-template.html` |
| Client Portal | Client — live project hub | scaffold | `commons/templates/portal-template.html` |
...
│   │   └── HTML_DESIGN_STANDARDS.md    Color palette, typography, component rules — the UI constitution
│   ├── templates/                      HTML shell templates + per-template CSS partials
│   │   ├── template-registry.json      Authoritative dictionary: all templates, audience, access, fill commands
│   │   ├── intake-template.html        + intake-base.css.html
│   │   ├── proposal-template.html      + proposal-base.css.html
│   │   ├── integration-deck-template.html  + integration-deck-base.css.html
│   │   ├── portal-template.html        + portal-base.css.html
│   │   ├── resource-template.html      + resource-base.css.html  (Architect Guide + long-form resources)
