...
├── commons/docs/AGENT-BOUNDARY-POLICY.md
├── commons/docs/FIELD_KNOWLEDGE.md
└── commons/docs/PLANNING_CONTEXT.md
```
...
├── deploy.sh
├── SETUP.md
└── commons/docs/HTML_PIPELINE_MIGRATION.md
```
...
├── query-connector.py
├── commons/docs/DESIGN_STANDARDS.md
├── commons/docs/PATTERNS_RESEARCH.md
└── pom.xml
```
...
- [x] `git mv commons/docs/PLANNING_CONTEXT.md pipeline/`
...
- [x] `git mv commons/docs/DESIGN_STANDARDS.md mulesoft/`
- [x] `git mv standards/doc-templates/ mulesoft/doc-templates/`
- [x] `git mv docs/PATTERNS_RESEARCH.md mulesoft/`
- [x] ~~`git mv commons/docs/DIAGRAM_FRAMEWORK.md mulesoft/`~~ reverted — lives in `docs/`
...
- [x] `git mv commons/docs/HTML_PIPELINE_MIGRATION.md portal/`
...
### Phase 13 — Implement `commons/docs/DIAGRAM_FRAMEWORK.md`

- [ ] Implement everything specified in `commons/docs/DIAGRAM_FRAMEWORK.md`
