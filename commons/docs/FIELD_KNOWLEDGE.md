...
Promotes to: commons/docs/PLANNING_CONTEXT.md (API CONTRACT DISCOVERY PROTOCOL section) — DONE 2026-05-10
...
Promotes to: commons/docs/DESIGN_STANDARDS.md — add multi-instance connector note when verified on second client
