...
**Priority:** P0
**Standard:** `standards/DESIGN_STANDARDS.md → Connector Registry → AI Connectors`
...
- Reference: `standards/DESIGN_STANDARDS.md → Connector Registry → AI Connectors (New Winter 2026)`
