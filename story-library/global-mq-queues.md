...
**Standard:** `standards/MULESOFT_DESIGN_STANDARDS.md → Flow Control Standards`
...
- Reference: `standards/MULESOFT_DESIGN_STANDARDS.md → Flow Control Standards → Default TTL Policy`
- Reference: `standards/MULESOFT_DESIGN_STANDARDS.md → Cross-Cutting Patterns → Idempotent Receiver`
